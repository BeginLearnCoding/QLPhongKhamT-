...
namespace PhongKham.Infrastructure.Migrations
{
    ...
    [Migration("20230724144608_fixRelationshipv1")]
    partial class fixRelationshipv1
    {
            ...
            modelBuilder.Entity("PhongKham.Core.Entities.PhieuKhamBenh", b =>
                {
                    ...
                    b.HasOne("PhongKham.Core.Entities.Benh", null)
                        .WithMany("phieuKhamBenhs")
                        .HasForeignKey("BenhId1");
